/* ── HUTKO — i18n.js ─────────────────────────────────
   Translation system for EN / UA / NL
   Usage: add data-i18n="key" to any HTML element.
   Switcher calls setLang('en'|'ua'|'nl').
   ─────────────────────────────────────────────────── */
...
const TRANSLATIONS = {
  ...
  en: {
    ...
    home_menu_label:  'Our menu',
    home_menu_title:  'Frozen & ready to love',
    ...
    home_partners_label: 'Our partners',
    home_partners_title: 'Trusted by',

    /* SHOP */
    shop_label:     'Frozen food',
    shop_title:     'Shop & Order',
    shop_cat_all:   'All products',
    shop_cat_soups: 'Soups',
    shop_cat_snacks:'Snacks & Bites',
    shop_cat_breakfast: 'Breakfast',
    shop_cat_mains: 'Main dishes',
    shop_sort:      'Sort by',
    ...
    checkout_free:    'Free delivery',
    checkout_free_desc:     'Available on orders over €60',
    ...
    checkout_success_desc:  'Thank you for your order. We\'ll send a confirmation email within 1 hour with your invoice and delivery details.',
    ...
    /* ACCOUNT */
    account_label:  'Your HUTKO account',
    ...
    account_street: 'Street address',
    account_post:   'Postcode',
    account_city:   'City',
    ...
    about_story_label:'Who we are',
    about_story_title:'The HUTKO story',
    about_food_label: 'A rich culinary heritage',
    about_food_title: 'The soul of Ukrainian cuisine',
    about_dishes_label:'Our menu, our heritage',
    about_dishes_title:'A story behind every dish',
    about_nl_label:   'Stay connected',
    about_nl_title:   'Want to know more?',
    about_nl_sub:     'Subscribe to our newsletter for Ukrainian food stories, new dishes, recipes and exclusive offers.',
    about_nl_placeholder: 'Your email address',
    about_nl_btn:     'Subscribe',
    about_nl_note:    'No spam, ever. Unsubscribe at any time.',
    about_nl_success: 'You\'re subscribed! Welcome to the HUTKO community.',

    /* DELIVERY */
    delivery_label:   'Getting your food',
    ...
    delivery_process_label: 'The process',
    delivery_process_title: 'How delivery works',
    delivery_coverage_label:'Coverage',
    delivery_coverage_title:'Where we deliver',
    delivery_join_label:    'Work with us',
    delivery_join_title:    'Join the HUTKO team',
    delivery_driver_title:  'Part-time delivery driver',
    delivery_partner_title: 'Become a partner',
    delivery_driver_btn:    'Apply as driver',
    delivery_partner_btn:   'Apply as partner',
    ...
    contact_follow: 'Follow us on social',
    ...
    contact_topic:  'Question regarding',
    contact_topic_ph: 'Select a topic…',
    contact_topic_media:   'Media & press',
    contact_topic_order:   'Ordering or cancelling',
    contact_topic_work:    'Apply for work',
    contact_topic_partner: 'Become a partner',
    contact_topic_other:   'Other',
    contact_msg_title: 'Message title',
    contact_msg_title_ph: 'Give your message a short title…',
    contact_msg_body: 'Your message',
    contact_msg_body_ph: 'Write your message here…',
    ...
    search_none:     'No products found for',
    search_all:      'Browse all products',
  },
  ...
  ua: {
    ...
    checkout_free_desc:     'При замовленні від €60',
    checkout_payment_title: 'Оплата при доставці або за рахунком',
    checkout_payment_desc:  'Ми приймаємо банківський переказ або готівку при доставці. Після замовлення надішлемо підтвердження на пошту.',
    ...
    checkout_success_desc:  'Дякуємо за замовлення. Ми надішлемо підтвердження на пошту протягом 1 години.',
    ...
    reg_pass:       'Пароль',
    reg_pass2:      'Підтвердження паролю',
    reg_btn:        'Створити акаунт',
    reg_have_account: 'Вже є акаунт?',
    reg_signin:     'Увійти',
    ...
    account_confirm_pass: 'Підтвердьте пароль',
    ...
    about_story_label:'Хто ми',
    about_story_title:'Історія HUTKO',
    ...
    delivery_driver_btn:    'Подати заявку як кур\'єр',
  ...
  nl: {
    nav_home:       'Home',
    nav_shop:       'Winkel / Bestellen',
    nav_about:      'Over ons',
    nav_delivery:   'Bezorging & info',
    nav_contact:    'Contact',
    nav_search:     'Zoek producten…',
    nav_signin:     'Inloggen',
    ...
    home_order_now:   'Bestel nu',
    home_our_story:   'Ons verhaal',
    home_menu_label:  'Ons menu',
    home_menu_title:  'Ingevroren met liefde',
    ...
    home_partners_label: 'Onze partners',
    home_partners_title: 'Vertrouwd door',

    shop_label:     'Diepvriesvoedsel',
    shop_title:     'Winkel & Bestellen',
    shop_cat_all:   'Alle producten',
    shop_cat_soups: 'Soepen',
    shop_cat_snacks:'Snacks & hapjes',
    shop_cat_breakfast: 'Ontbijt',
    shop_cat_mains: 'Hoofdgerechten',
    shop_sort:      'Sorteren op',
    shop_sort_featured:   'Aanbevolen',
    shop_sort_price_asc:  'Prijs: laag naar hoog',
    shop_sort_price_desc: 'Prijs: hoog naar laag',
    shop_sort_name:       'Naam: A–Z',
    shop_search:    'Zoek producten…',
    shop_add:       'In winkelwagen',
    shop_added:     'Toegevoegd ✓',
    shop_from:      'vanaf',

    cart_title:     'Uw bestelling',
    cart_empty:     'Uw winkelwagen is leeg.\nVoeg heerlijk eten toe!',
    cart_total:     'Totaal',
    cart_checkout:  'Naar afrekenen →',

    checkout_label:   'Bijna klaar',
    checkout_title:   'Afrekenen',
    checkout_contact: 'Contactgegevens',
    checkout_address: 'Bezorgadres',
    checkout_method:  'Bezorgmethode',
    ...
    checkout_street:  'Straat en huisnummer',
    checkout_postcode:'Postcode',
    checkout_city:    'Stad',
    checkout_province:'Provincie',
    ...
    checkout_free:    'Gratis bezorging',
    checkout_free_desc:     'Beschikbaar bij bestellingen boven €60',
    checkout_payment_title: 'Betaling bij levering of via factuur',
    checkout_payment_desc:  'Wij accepteren bankoverschrijving of contant bij levering. Na uw bestelling sturen wij een bevestiging per e-mail.',
    checkout_summary: 'Bestellingsoverzicht',
    checkout_subtotal:'Subtotaal',
    checkout_delivery:'Bezorging',
    checkout_place:   'Bestelling plaatsen →',
    ...
    checkout_view_orders:   'Mijn bestellingen',
    checkout_continue:      'Verder winkelen',
    ...
    reg_fname:      'Voornaam',
    reg_lname:      'Achternaam',
    reg_email:      'E-mailadres',
    reg_phone:      'Telefoonnummer',
    reg_pass:       'Wachtwoord',
    reg_pass2:      'Wachtwoord bevestigen',
    reg_btn:        'Account aanmaken',
    reg_have_account: 'Al een account?',
    reg_signin:     'Inloggen',

    account_label:  'Uw HUTKO-account',
    account_orders: '📦 Mijn bestellingen',
    account_profile:'👤 Profiel',
    account_address:'📍 Opgeslagen adres',
    account_signout:'↩ Uitloggen',
    account_no_orders: 'U heeft nog geen bestellingen geplaatst.',
    account_shop:   'Begin met winkelen',
    account_save_profile: 'Wijzigingen opslaan',
    account_save_address: 'Adres opslaan',
    account_change_pass:  'Wachtwoord wijzigen',
    account_new_pass:     'Nieuw wachtwoord',
    account_confirm_pass: 'Wachtwoord bevestigen',
    account_street: 'Straat en huisnummer',
    account_post:   'Postcode',
    account_city:   'Stad',
    account_province: 'Provincie',

    about_hero_label: 'Ons verhaal',
    about_hero_title: 'Met liefde gemaakt, geworteld in traditie',
    about_hero_sub:   'Een klein Oekraïens familiebedrijf dat de warmte van de thuiskeuken naar Nederland brengt.',
    about_story_label:'Wie wij zijn',
    about_story_title:'Het HUTKO-verhaal',
    about_food_label: 'Een rijke culinaire erfenis',
    about_food_title: 'De ziel van de Oekraïense keuken',
    about_dishes_label:'Ons menu, ons erfgoed',
    about_dishes_title:'Achter elk gerecht schuilt een verhaal',
    about_nl_label:   'Blijf verbonden',
    about_nl_title:   'Meer weten?',
    about_nl_sub:     'Abonneer u op onze nieuwsbrief voor Oekraïense kookverhalen, nieuwe gerechten en exclusieve aanbiedingen.',
    about_nl_placeholder: 'Uw e-mailadres',
    about_nl_btn:     'Abonneren',
    about_nl_note:    'Geen spam. Uitschrijven kan altijd.',
    about_nl_success: 'U bent geabonneerd! Welkom bij de HUTKO-gemeenschap.',

    delivery_label:   'Uw bestelling ontvangen',
    delivery_title:   'Bezorging & info',
    delivery_sub:     'Alles wat u moet weten over hoe wij HUTKO-diepvriesvoedsel bij u bezorgen.',
    delivery_process_label: 'Het proces',
    delivery_process_title: 'Hoe bezorging werkt',
    delivery_coverage_label:'Dekking',
    delivery_coverage_title:'Waar wij bezorgen',
    delivery_join_label:    'Werk met ons',
    delivery_join_title:    'Word deel van het HUTKO-team',
    delivery_driver_title:  'Bezorger parttime',
    delivery_partner_title: 'Word partner',
    delivery_driver_btn:    'Solliciteer als bezorger',
    delivery_partner_btn:   'Word partner',

    contact_label:  'Neem contact op',
    contact_title:  'Wij horen graag van u',
    ...
    contact_form_label: 'Stuur een bericht',
    contact_form_title: 'Hoe kunnen wij helpen?',
    contact_name:   'Volledige naam',
    contact_email:  'E-mailadres',
    contact_phone:  'Telefoonnummer',
    contact_social: 'Social media',
    contact_topic:  'Vraag betreft',
    contact_topic_ph: 'Kies een onderwerp…',
    contact_topic_media:   'Media & pers',
    contact_topic_order:   'Bestellen of annuleren',
    contact_topic_work:    'Sollicitatie',
    contact_topic_partner: 'Partner worden',
    contact_topic_other:   'Overig',
    contact_msg_title: 'Onderwerp',
    contact_msg_title_ph: 'Geef uw bericht een korte titel…',
    contact_msg_body: 'Uw bericht',
    contact_msg_body_ph: 'Schrijf uw bericht hier…',
    ...
    search_for:      'Resultaten voor',
    search_none:     'Geen producten gevonden voor',
    search_all:      'Bekijk alle producten',
  }
};
...
function setLang(lang) {
  ...
  applyTranslations();
  updateLangSwitcher();
  /* Re-render components that build HTML dynamically */
  if (typeof renderNavbar === 'function') {
    document.getElementById('navbar-placeholder').innerHTML = '';
    renderNavbar();
    /* Re-attach hamburger after re-render */
