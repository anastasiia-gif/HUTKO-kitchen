...
const TRANSLATIONS = {
    en: {
        ...
        prod_ingredients_title: 'Ingredients',
        prod_prepare_title: 'How to prepare',
        prod_custom_title: 'Custom order?',
        prod_custom_desc: 'We can make this product in custom formats — just contact us!',
        prod_contact_q: 'Have a question about this product?',
        prod_contact_sub: "We're happy to help — allergies, custom orders, B2B inquiries.",
        prod_contact_btn: 'Contact us →',
        prod_chip_ready: 'Ready in',
        prod_chip_storage: 'Storage',
    ...
    ua: {
        ...
        prod_chip_storage: 'Зберігання', 'Доставляємо по всій<br>Нідерландах',
    ...
    nl: {
        ...
        prod_custom_desc: 'Wij kunnen dit product in aangepaste formaten maken — neem gewoon contact op!',
